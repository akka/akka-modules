 ...
 * <p/>
 * This backend is the 'Classic' Akka offering which uses
 * Array[Byte] storage rather than native MongoDB persistence.
 * <p/>
 ...
 * @see MongoNativeStorageBackend
 */
private[akka] object MongoClassicStorageBackend extends
  MapStorageBackend[Array[Byte], Array[Byte]] with
  VectorStorageBackend[Array[Byte]] with
  RefStorageBackend[Array[Byte]] with
  MongoBackendConfiguration with
  Logging {

...
class BankAccountActor extends Actor {
  private val accountState = HbaseStorage.newMap(state)
  private val txnLog = HbaseStorage.newVector(tx)
...
class HbasePersistentActorSuite extends
Spec with
ShouldMatchers with
BeforeAndAfterEach with EmbeddedHbase {
